...
export const farcasterConfig = {
  ...
  miniapp: {
    ...
    tagline: "One link. One payment.",
    ogTitle: "Pay Link",
    ogDescription: "Create and share USDC payment links on Base.",
    ...
    iconUrl: `${ROOT_URL}/distribution/icon-1024-v2.png`,
    splashImageUrl: `${ROOT_URL}/distribution/splash-200-v2.png`,
    splashBackgroundColor: "#000000",
    homeUrl: ROOT_URL,
    primaryCategory: "finance",
    tags: ["payments", "usdc", "base", "links"],
    heroImageUrl: `${ROOT_URL}/distribution/hero-home.png`,
    ogImageUrl: `${ROOT_URL}/distribution/og-share-v2.png`,
  },
} as const;
