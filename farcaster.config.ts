...
export const farcasterConfig = {
  ...
  miniapp: {
    ...
    screenshotUrls: [`${ROOT_URL}/logo-monogram.svg`],
    iconUrl: `${ROOT_URL}/logo-monogram.svg`,
    splashImageUrl: `${ROOT_URL}/logo-monogram.svg`,
    splashBackgroundColor: "#000000",
    homeUrl: ROOT_URL,
    webhookUrl: `${ROOT_URL}/api/webhook`,
    primaryCategory: "finance",
    tags: ["payments", "usdc", "base", "links"],
    heroImageUrl: `${ROOT_URL}/logo-monogram.svg`,
    tagline: "",
    ogTitle: "",
    ogDescription: "",
    ogImageUrl: `${ROOT_URL}/logo-monogram.svg`,
  },
} as const;
